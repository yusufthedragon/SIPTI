          ...
          <div id="gruppembelian">
            <div id="pembelian1">
              <div class="col s4">
                ...
                <input type="text" id="no1" name="no1" class="center autocomplete" onkeyup="autofill(this), autohitung(), upperCaseF(this)" onblur="autofill(this), autohitung(), upperCaseF(this)"/>
              </div>
              <div class="col s4">
